    ...
    <div className={styles.container}>
      ...
      <div className={styles.blogContent}>
        ...
        <p className={styles.description}>
          ...
          on what I&apos;ve learned throughout the years I have been studying
          web development. I will cover the beginning of my journey all the way
          ...
          will be the mouthpiece I use to tell everyone how I&apos;m going about
          it.
        </p>

        <p className={styles.description}>
          <b>Lastly</b>, I&apos;ve always wanted to run a blog. Having
          experience writing for a blog can translate into a lot of powerful
          opportunities, like marketing for a business or cultivating a large
          audience. This kind of experience is invaluable to me, and I&apos;d
          love to start with this very blog. My promise is that what you will
          find in this blog will help you, whether you are an absolute beginner
          to web development or an advanced programmer. I want to provide the
          perspective of someone passionate about coding and web development,
          and what I think the best way to get into web development is.
        </p>
